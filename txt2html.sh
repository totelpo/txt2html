...
# USAGE: 
  echo "
$fn_name TEXT_FILE   OUT_DIR DOC_TYPE
$fn_name sample.txt  ~/t
$fn_name sample.txt  ~/t     bug
...
if [ $# -gt 1 ]; then
  ...
  p_menu_html="$4"; p_menu_html=${p_menu_html:=$fn_dirname/menu.html} # default value
  p_style_html="$5"; p_style_html=${p_style_html:=$fn_dirname/style.html} # default value
